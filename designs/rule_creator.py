        ...
        * High 
        ...
        if not has_rule_named(onto=self.ontology, name="very_low_hr_rule"): 
            Imp("very_low_hr_rule").set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hr_inst), 
                HR(?hr_inst), hasNumericalValue(?hr_inst, ?value), 
                appliesHRLow(?tp, ?hr_low), hasThrValue(?hr_low, ?low), 
                greaterThanOrEqual(?value, 0), 
                lessThan(?value, ?low), 
                Very_Low_HR(?vrl_hr)  ->  HRis(?hr_inst, ?vrl_hr) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="moderate_hr_rule"): 
            Imp("moderate_hr_rule").set_as_rule(
                ...
                lessThan(?value, ?high), 
                Moderate_HR(?m_hr)  ->  HRis(?hr_inst, ?m_hr) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="high_hr_rule"): 
            Imp("high_hr_rule").set_as_rule(
                ...
                lessThan(?value, 250), 
                High_HR(?h_hr)  ->  HRis(?hr_inst, ?h_hr) 
                """
            )
        ...
        * High 
        ...
        if not has_rule_named(onto=self.ontology, name="very_low_hrv_rule"): 
            Imp("very_low_hrv_rule").set_as_rule(
                f"""
                ActorState(?act_st), validAt(?act_st, ?t), StateHasThresholdProfile(?act_st, ?tp), 
                ActorStateHasPhysiologicalState(?act_st, ?hrv_inst),
                HRV(?hrv_inst), hasNumericalValue(?hrv_inst, ?value), 
                appliesHRVLow(?tp, ?hrv_low), hasThrValue(?hrv_low, ?low), 
                greaterThanOrEqual(?value, 0), 
                lessThan(?value, ?low), 
                Very_Low_HRV(?vrl_hrv) ->  HRVis(?hrv_inst, ?vrl_hrv)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="low_hrv_rule"): 
            Imp("low_hrv_rule").set_as_rule(
                ...
                greaterThanOrEqual(?value, ?low), 
                lessThan(?value, ?mod), 
                Low_HRV(?l_hrv) ->  HRVis(?hrv_inst, ?l_hrv)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="moderate_hrv_rule"): 
            Imp("moderate_hrv_rule").set_as_rule(
                ...
                greaterThanOrEqual(?value, ?mod), 
                lessThan(?value, ?high), 
                Moderate_HRV(?mod_hrv) -> HRVis(?hrv_inst, ?mod_hrv)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="high_hrv_rule"): 
            Imp("high_hrv_rule").set_as_rule(
                ...
                greaterThanOrEqual(?value, ?high),
                lessThan(?value, 250), 
                High_HRV(?high_hrv) -> HRVis(?hrv_inst, ?high_hrv)
                """
            )
        ...
        * High 
        ...
        if not has_rule_named(onto=self.ontology, name="very_low_rr_rule"):
            Imp("very_low_rr_rule").set_as_rule(
                f"""
                ActorState(?act_st), validAt(?act_st, ?t), StateHasThresholdProfile(?act_st, ?tp), 
                ActorStateHasPhysiologicalState(?act_st, ?rr_inst),
                RR(?rr_inst), hasNumericalValue(?rr_inst, ?value), 
                appliesRRLow(?tp, ?rr_low), hasThrValue(?rr_low, ?low), 
                greaterThanOrEqual(?value, 0), 
                lessThan(?value, ?low), 
                Very_Low_RR(?vrl_rr) ->  RRis(?rr_inst, ?vrl_rr) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name="moderate_rr_rule"): 
             Imp("moderate_rr_rule").set_as_rule(
                ...
                greaterThanOrEqual(?value, ?mod),
                lessThan(?value, ?high), 
                Moderate_RR(?mod_rr) ->  RRis(?rr_inst, ?mod_rr)
                """
             )
        ...
        if not has_rule_named(onto=self.ontology, name="high_rr_rule"): 
             Imp("high_rr_rule").set_as_rule(
                ...
                greaterThanOrEqual(?value, ?high),  
                lessThan(?value, 50), 
                High_RR(?high_rr) ->  RRis(?rr_inst, ?high_rr)
                """
             )
        ...
        * Critical
        ...
        if not has_rule_named(onto=self.ontology, name="normal_spo2_rule"): 
             Imp("normal_spo2_rule").set_as_rule(
                f"""
                ActorState(?act_st), validAt(?act_st,?t),  StateHasThresholdProfile(?act_st, ?tp), 
                ActorStateHasPhysiologicalState(?act_st, ?spo2_inst),
                SpO2(?spo2_inst), hasNumericalValue(?spo2_inst, ?value), 
                ...
                Normal_SpO2(?nrm_spo2) ->  SpO2is(?spo2_inst, ?nrm_spo2)
                """
             )
        ...
        if not has_rule_named(onto=self.ontology, name="low_spo2_rule"): 
             Imp("low_spo2_rule").set_as_rule(
                ...
                Low_SpO2(?l_spo2) ->  SpO2is(?spo2_inst, ?l_spo2)
                """
             )
        ...
        if not has_rule_named(onto=self.ontology, name="critical_spo2_rule"): 
             Imp("critical_spo2_rule").set_as_rule(
                ...
                SpO2(?spo2_inst), hasNumericalValue(?spo2_inst, ?value), 
                lessThan(?value, ?low),  
                Critical_SpO2(?critical_spo2) -> SpO2is(?spo2_inst, ?critical_spo2)
                """
             )
    ...
    def determine_drowsiness(self): 
        ...
        * Level_9 (actor is asleep with effort of waking up)
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_state), validAt(?act_state, ?t), ActorStateHasPhysiologicalState(?act_state, ?dr_inst),
                Drowsiness(?dr_inst), hasNumericalValue(?dr_inst, ?v), 
                lessThanOrEqual(?v, 1), greaterThan(?v, 0), Level_3_KSS(?l3kss) 
                -> DrowsinessIs(?dr_inst, ?l3kss) 
                """
            )
    ...
    def determine_fatigue(self): 
        ...
        * Undefined State
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_st), validAt(?act_st, ?t),  ActorStateHasPhysiologicalState(?act_st, ?spo2), 
                SpO2(?spo2), SpO2is(?spo2, ?critical), Critical_SpO2(?critical), 
                ActorStateHasFatigue(?act_st, ?fatigue_inst),  Fatigue(?fatigue_inst), UndefinedState(?und_inst)
                -> FatigueIs(?fatigue_inst, ?und_inst)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_st), validAt(?act_st, ?t), ActorStateHasPhysiologicalState(?act_st, ?dr), Drowsiness(?dr), DrowsinessIs(?dr, ?lvl3), Level_3_KSS(?lvl3), 
                ...
                ActorStateHasFatigue(?act_st, ?fatigue_inst), Fatigue(?fatigue_inst), Awake(?awake_instance) 
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                # """
                # ActorState(?act_st),
                # ActorStateHasPhysiologicalState(?act_st, ?dr_inst), Drowsiness(?dr_inst),DrowsinessIs(?dr_inst, ?lvl3), Level_3_KSS(?lvl3), 
                # ActorStateHasPhysiologicalState(?act_st, ?hr_inst), HR(?hr_inst), HRis(?hr_inst, ?mod_hr), Moderate_HR(?mod_hr), 
                # ActorStateHasPhysiologicalState(?act_st, ?hrv_inst), HRV(?hrv_inst), HRVis(?hrv_inst, ?high_hrv), High_HRV(?high_hrv), 
                # ActorStateHasPhysiologicalState(?act_st, ?rr_inst), RR(?rr_inst), RRis(?rr_inst, ?mod_rr), Moderate_RR(?mod_rr), 
                # ActorStateHasPhysiologicalState(?act_st, ?spo2_inst), SpO2(?spo2_inst), SpO2is(?spo2_inst, ?nor), Normal_SpO2(?nor), 
                # Fatigue(?fatigue_inst), Awake(?awake) -> ActorStateHasFatigue(?act_st, ?fatigue_inst), FatigueIs(?fatigue_inst, ?awake) 
                # """
                """
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_st), validAt(?act_st, ?t), ActorStateHasPhysiologicalState(?act_st, ?dr), Drowsiness(?dr), DrowsinessIs(?dr, ?lvl5), Level_5_KSS(?lvl5), 
                ActorStateHasPhysiologicalState(?act_st, ?hr), HR(?hr), HRis(?hr, ?mod_hr), Moderate_HR(?mod_hr), 
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasPhysiologicalState(?act_st, ?spo2), SpO2(?spo2), SpO2is(?spo2, ?nor), Normal_SpO2(?nor), 
                ActorStateHasFatigue(?act_st, ?fatigue_inst), Fatigue(?fatigue_inst), Awake(?awake_instance), Level_3_KSS(?lvl3)
                ->  FatigueIs(?fatigue_inst, ?awake_instance), DrowsinessIs(?dr, ?lvl3) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?spo2), SpO2(?spo2), SpO2is(?spo2, ?nor), Normal_SpO2(?nor), 
                ActorStateHasFatigue(?act_st, ?fatigue_inst), Fatigue(?fatigue_inst), Sleep(?sleep),  Level_9_KSS(?lvl9),
                ->  FatigueIs(?fatigue_inst, ?sleep), DrowsinessIs(?dr, ?lvl9) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?high_rr), High_RR(?high_rr), 
                ActorStateHasPhysiologicalState(?act_st, ?spo2), SpO2(?spo2), SpO2is(?spo2, ?nor), Normal_SpO2(?nor), 
                ActorStateHasFatigue(?act_st, ?fatigue_inst), Fatigue(?fatigue_inst), DrowsinessSuspected(?dr_sus), Level_5_KSS(?lvl5),
                -> FatigueIs(?fatigue_inst, ?dr_sus), DrowsinessIs(?dr, ?lvl5) 
                """
            ) 
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasFatigue(?act_st, ?fatigue_inst), Fatigue(?fatigue_inst), DrowsinessSuspected(?dr_sus), Level_7_KSS(?lvl7)
                -> FatigueIs(?fatigue_inst, ?dr_sus), DrowsinessIs(?dr, ?lvl7)
                """
            )
    ...
    def determine_attention(self): 
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_st),validAt(?act_st, ?t), ActorStateHasPhysiologicalState(?act_st, ?spo2), 
                SpO2(?spo2), SpO2is(?spo2, ?crit), Critical_SpO2(?crit), ActorStateHasAttention(?act_st, ?att),
                AttentionLevels(?att), UndefinedState(?dnf) ->  AttentionIs(?att, ?dnf)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Attentive(?mod_att), Level_5_KSS(?lvl5) ->
                AttentionIs(?attention_inst, ?mod_att), DrowsinessIs(?dr, ?lvl5)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Attentive(?high_att) ->
                AttentionIs(?attention_inst, ?high_att)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Attentive(?high_att), Level_3_KSS(?lvl3) ->
                AttentionIs(?attention_inst, ?high_att), DrowsinessIs(?dr, ?lvl3)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?high_hrv), High_HRV(?high_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Attentive(?mod_att) ->
                AttentionIs(?attention_inst, ?mod_att) 
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                """
                ActorState(?act_st),validAt(?act_st, ?t), ActorStateHasPhysiologicalState(?act_st, ?dr), Drowsiness(?dr), DrowsinessIs(?dr, ?lvl9), 
                Level_9_KSS(?lvl9), ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Inattentive(?inatt) ->
                AttentionIs(?attention_inst, ?inatt)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst) -> AttentionIs(?attention_inst, inattentive_instance)
                """
            )
        return     
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?mod_hrv), Moderate_HRV(?mod_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?mod_rr), Moderate_RR(?mod_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst), AttentionLevels(?attention_inst), Inattentive(?inatt), Level_9_KSS(?lvl9) ->
                AttentionIs(?attention_inst, ?inatt), DrowsinessIs(?dr, ?lvl9)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?vrl_hrv), Very_Low_HRV(?vrl_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?high_rr), High_RR(?high_rr), 
                AttentionLevels(?attention_inst), Inattentive(?inatt), Level_9_KSS(?lvl9) ->
                AttentionIs(?attention_inst, ?inatt), DrowsinessIs(?dr, ?lvl9)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?hrv), HRV(?hrv), HRVis(?hrv, ?vrl_hrv), Very_Low_HRV(?vrl_hrv), 
                ActorStateHasPhysiologicalState(?act_st, ?rr), RR(?rr), RRis(?rr, ?vrl_rr), Very_Low_RR(?vrl_rr), 
                ActorStateHasAttention(?act_st, ?attention_inst),AttentionLevels(?attention_inst), Inattentive(?inatt), Level_7_KSS(?lvl7) ->
                AttentionIs(?attention_inst, ?inatt), DrowsinessIs(?dr, ?lvl7)
                """
            )
    ...
    def determine_unresponsiveness(self): 
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                Unresponsiveness(?unresp_inst), ActorStateHasUnresponsiveness(?act_st, ?unresp_inst), Responsive(?repo) ->  UnresponsiveIs(?unresp_inst, ?repo)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                Unresponsiveness(?unresp_inst), ActorStateHasUnresponsiveness(?act_st, ?unresp_inst),AtRisk(?atrisk) ->  UnresponsiveIs(?unresp_inst, ?atrisk)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?spo2),  SpO2is(?spo2, ?l_spo2), Low_SpO2(?l_spo2), 
                Unresponsiveness(?unresp_inst), ActorStateHasUnresponsiveness(?act_st, ?unresp_inst), Imminent(?immi) -> UnresponsiveIs(?unresp_inst, ?immi)
                """
            )
        ...
        if not has_rule_named(onto=self.ontology, name=rule_name): 
            Imp(rule_name).set_as_rule(
                ...
                ActorStateHasPhysiologicalState(?act_st, ?spo2),  SpO2is(?spo2, ?l_spo2), Low_SpO2(?l_spo2), 
                Unresponsiveness(?unresp_inst),  ActorStateHasUnresponsiveness(?act_st, ?unresp_inst),Unresponsive(?not) -> UnresponsiveIs(?unresp_inst, ?not)
                """
            )
